...
/**
 * Builds a query (prepared query statement) to obtain flex object keys relevant to extract article details for Aero CAP integration.<br>
 * 
 * @author Acnovate
 * @see "Task #9424 Aero - Development"
 * @see "Task #9645 Aero - Article Interface"
 */
public class AeroCAPArticleDetailsQueryBuilder extends AeroCAPArticleIdsQueryBuilder {
	 ...
	 */
	public AeroCAPArticleDetailsQueryBuilder(String colorwayNumber) {
