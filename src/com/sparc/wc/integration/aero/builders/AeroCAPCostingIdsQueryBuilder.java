...
/**
 * Builds a query (prepared query statement) to obtain the list of sourcing config numbers that contain eligible cost sheets for Aero CAP integration.<br>
 * 
 * @author Acnovate
 * @see "Task #9424 Aero - Development"
 * @see "Task #9646 Aero - Costing Interface"
 */
public class AeroCAPCostingIdsQueryBuilder extends AeroCostingIdsQueryBuilder {
	
	public AeroCAPCostingIdsQueryBuilder() {
