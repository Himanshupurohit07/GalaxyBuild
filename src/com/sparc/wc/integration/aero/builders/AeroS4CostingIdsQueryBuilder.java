...
/**
 * Builds a query (prepared query statement) to obtain the list of sourcing config numbers that contain eligible cost sheets for Aero S4 integration.<br>
 * 
 * @author Acnovate
 * @see "Task #9424 Aero - Development"
 * @see "Task #9646 Aero - Costing Interface"
 */
public class AeroS4CostingIdsQueryBuilder extends AeroCostingIdsQueryBuilder {

	public AeroS4CostingIdsQueryBuilder() {
	 ...
	 * <li>Sourcing status is "Development" or "Confirmed" OR "Dropped" if Sourcing Config Sent to S4 is Yes.</li>
	 * </ul>
	 * @param pqs The prepared statement to be updated.
	 * @throws WTException If an error occurs while using the flex api to retrieve column metadata info from PLM.
	 */
