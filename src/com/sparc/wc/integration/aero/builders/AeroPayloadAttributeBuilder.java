...
/**
 * Builds a Payload Attribute applicable for Aeropostale Integrations.<br>
 * 
 * FIXES/AMENDMENTS:<br>
 * - Added support for Enum's Aero Secondary Key.<br>
 * - Corrected attribute key info for use of enum display name 'enumdpname'.<br>
 * - Task #11142: Added support to compvaluedelimiterkey attribute key to handle custom delimiters for composte attribute values.<br>
 * 
 * @author Acnovate
 * @see "Task #9424 Aero - Development"
 */
public class AeroPayloadAttributeBuilder {
	...
	private AeroPayloadAttribute payloadAttribute;
	
	/**
	 * Builds an AeroPayloadAttribute instance.
	 * @param payloadAttribute The AeroPayloadAttribute insatance to build.
	 */
	public AeroPayloadAttributeBuilder(AeroPayloadAttribute payloadAttribute) {
	 ...
	 */
	public AeroPayloadAttribute build(String attributeDefinition) {
