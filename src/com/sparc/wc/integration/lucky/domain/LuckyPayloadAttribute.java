...
import com.ptc.core.lwc.server.LWCEnumerationDefinition;
import com.sparc.wc.integration.lucky.builders.LuckyPayloadAttributeBuilder;


public class LuckyPayloadAttribute {
    ...
    public static LuckyPayloadAttributeBuilder newBuilder() {
        return new LuckyPayloadAttributeBuilder(new LuckyPayloadAttribute());
    }

    private LuckyPayloadAttribute() {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        LuckyPayloadAttribute other = (LuckyPayloadAttribute) obj;
