 ...
 * @author Chuck
 */
public class SPARCPDFProductSpecificationHeader2 extends PdfPTable implements PDFHeader {
	...
	private static  String LUCKY_LEFT_HEADER2_KEYNAMES = "";
	private static  String LUCKY_RIGHT_HEADER2_KEYNAMES = "";

	private static  String AEROPOSTALE_LEFT_HEADER2_KEYNAMES = "";
	private static  String AEROPOSTALE_RIGHT_HEADER2_KEYNAMES = "";
	
	private static  String NAUTICA_LEFT_HEADER2_KEYNAMES = "";
	private static  String NAUTICA_RIGHT_HEADER2_KEYNAMES = "";
	
	
	private static final String F21_LEFT_HEADER2_KEYNAMES = LCSProperties.get("com.sparc.f21.leftHeader2KeyDisplayNames");
	private static final String F21_RIGHT_HEADER2_KEYNAMES = LCSProperties.get("com.sparc.f21.rightHeader2KeyDisplayNames");
    ...
    static {
        try {
            ...
            LUCKY_LEFT_HEADER2_KEYNAMES = LCSProperties.get("com.sparc.lucky.leftHeader2KeyDisplayNames");
			LUCKY_RIGHT_HEADER2_KEYNAMES = LCSProperties.get("com.sparc.lucky.rightHeader2KeyDisplayNames");
			
			AEROPOSTALE_LEFT_HEADER2_KEYNAMES = LCSProperties.get("com.sparc.aeropostale.leftHeader2KeyDisplayNames");
			AEROPOSTALE_RIGHT_HEADER2_KEYNAMES = LCSProperties.get("com.sparc.aeropostale.rightHeader2KeyDisplayNames");
			
			NAUTICA_LEFT_HEADER2_KEYNAMES = LCSProperties.get("com.sparc.nautica.leftHeader2KeyDisplayNames");
			NAUTICA_RIGHT_HEADER2_KEYNAMES = LCSProperties.get("com.sparc.nautica.rightHeader2KeyDisplayNames");
     ...
     */
    public SPARCPDFProductSpecificationHeader2() {
    }
     ...
     */
    public SPARCPDFProductSpecificationHeader2(int cols) {
        super(cols);
    }
    ...
    public Element getPDFHeader(Map params)  {
		 ...
		 SPARCPDFProductSpecificationHeader2 ppsh = new SPARCPDFProductSpecificationHeader2(4);
        try {
			...
			}else if(productFlexType.contains("Lucky")){
    ...
    private PdfPCell createImageCell(String imageAllignString, LCSProduct productObj,String brand) throws WTException {
        try {
			...
			if("LEFT".equals(imageAllignString)){
 				...
 				//System.out.println("Lucky equals Ignore case---------------------"+"Lucky".equalsIgnoreCase(brand));
	...
	private PdfPCell createLuckyDataCell(Map params,String cellAllignment,String strType) throws WTException {
		try {
			...
			//System.out.println("mapObjects---------LATEST----HEADER 2-------------------"+mapObjects);
			List<Map.Entry<String, String>> luckyHeaderkeys = new ArrayList<>();			
			luckyHeaderkeys = getLuckyHeaderKeys(cellAllignment,strType);
			//System.out.println("luckyHeaderkeys------LATEST------HEADER 2-------"+luckyHeaderkeys);
	...
	private List<Map.Entry<String, String>> getLuckyHeaderKeys(String cellAlignment,String strType) {
	    ...
	    if ("LEFT".equalsIgnoreCase(cellAlignment)) {
	        luckyHeaderKeys = "Lucky".equalsIgnoreCase(strType)? SparcUtil.getListFromBrandContext(LUCKY_LEFT_HEADER2_KEYNAMES):SparcUtil.getListFromBrandContext(F21_LEFT_HEADER2_KEYNAMES);
	    } else {
	        luckyHeaderKeys = "Lucky".equalsIgnoreCase(strType)?SparcUtil.getListFromBrandContext(LUCKY_RIGHT_HEADER2_KEYNAMES):SparcUtil.getListFromBrandContext(F21_RIGHT_HEADER2_KEYNAMES);
	    }
	    */
	    
	    if ("LEFT".equalsIgnoreCase(cellAlignment)) {
			if ("Lucky".equalsIgnoreCase(strType)) {
				luckyHeaderKeys = SparcUtil.getListFromBrandContext(LUCKY_LEFT_HEADER2_KEYNAMES);
			} 
			else if ("Aeropostale".equalsIgnoreCase(strType)) {
				luckyHeaderKeys = SparcUtil.getListFromBrandContext(AEROPOSTALE_LEFT_HEADER2_KEYNAMES);
			}
			else if ("Nautica".equalsIgnoreCase(strType)) {
				luckyHeaderKeys = SparcUtil.getListFromBrandContext(NAUTICA_LEFT_HEADER2_KEYNAMES);
			}else {
				luckyHeaderKeys = SparcUtil.getListFromBrandContext(F21_LEFT_HEADER2_KEYNAMES);
			}
		} else {
			if ("Lucky".equalsIgnoreCase(strType)) {
				luckyHeaderKeys = SparcUtil.getListFromBrandContext(LUCKY_RIGHT_HEADER2_KEYNAMES);
			} 
			else if ("Aeropostale".equalsIgnoreCase(strType)) {
				luckyHeaderKeys = SparcUtil.getListFromBrandContext(AEROPOSTALE_RIGHT_HEADER2_KEYNAMES);
			}
			else if ("Nautica".equalsIgnoreCase(strType)) {
				luckyHeaderKeys = SparcUtil.getListFromBrandContext(NAUTICA_RIGHT_HEADER2_KEYNAMES);
			}else {
				luckyHeaderKeys = SparcUtil.getListFromBrandContext(F21_RIGHT_HEADER2_KEYNAMES);
			}
		}
