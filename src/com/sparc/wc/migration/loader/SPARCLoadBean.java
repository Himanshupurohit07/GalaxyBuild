...
public abstract class SPARCLoadBean extends LoadCommon{
	...
	protected static FlexSpecification getExistingSpecForSource(FlexType specifcationFlexType,
		...
		String descAttCol = specifcationFlexType.getAttribute("scDescription").getColumnName();
		String flexSpecDescription = (String)specValue.get("flexAttscDescription");
		...
		pqs.appendAndIfNeeded();
		pqs.appendCriteria(new Criteria("FlexSpecification", descAttCol, flexSpecDescription, Criteria.EQUALS));
	...
	protected static void createObjectToSeasonLinK(Hashtable dataValues, Object obj,
			LCSSeason season, String fileName) throws WTException {
		// TODO Auto-generated method stub
		if(obj instanceof LCSSourcingConfig) {
			...
			if(flexSpecToSeasonLink==null) {
				new FlexSpecLogic().addSpecToSeason(flexSpec.getMaster(), season.getMaster());
