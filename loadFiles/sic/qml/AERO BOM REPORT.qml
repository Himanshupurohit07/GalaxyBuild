...
<qml bypassAccessControl="false" caseInsensitive="true" addTimeToDateFields="false" mainType="Aeropostale (com.ptcmscloud.scAeropostale_com_lcs_wc_product_LCSProduct)" joinModel="false" xsi:noNamespaceSchemaLocation="qml.xsd" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
  <query>
    <selectOrConstrain distinct="false" group="false">
      <reportAttribute heading="Season Name" reportAttributeId="Name" userCanSelect="true" userCanConstrain="true" alwaysSelect="false" defaultValue="" constantValue="" isMacro="false">
        <column alias="Aeropostale (com.ptcmscloud.scAeropostaleSeason)" isExternal="false" type="java.lang.String" propertyName="WCTYPE|com.lcs.wc.season.LCSSeason|com.ptcmscloud.scAeropostaleSeason~MBA|typeInfoLCSSeason.ptc_str_4">WCTYPE|com.lcs.wc.season.LCSSeason|com.ptcmscloud.scAeropostaleSeason~MBA|typeInfoLCSSeason.ptc_str_4</column>
      </reportAttribute>
      <reportAttribute heading="Product Name" reportAttributeId="Name_5" userCanSelect="true" userCanConstrain="true" alwaysSelect="false" defaultValue="" constantValue="" isMacro="false">
        <column alias="Aeropostale (com.ptcmscloud.scAeropostale_com_lcs_wc_product_LCSProduct)" isExternal="false" type="java.lang.String" propertyName="name">master&gt;name</column>
      </reportAttribute>
      <reportAttribute heading="PLM Product No" reportAttributeId="PLM_Product__1" userCanSelect="true" userCanConstrain="true" alwaysSelect="false" defaultValue="" constantValue="" isMacro="false">
        <column alias="Aeropostale (com.ptcmscloud.scAeropostale_com_lcs_wc_product_LCSProduct)" isExternal="false" type="java.lang.Long" propertyName="WCTYPE|com.lcs.wc.product.LCSProduct|com.ptcmscloud.scApparel$com_lcs_wc_product_LCSProduct|com.ptcmscloud.scAeropostale$com_lcs_wc_product_LCSProduct~MBA|typeInfoLCSProduct.ptc_lng_1">WCTYPE|com.lcs.wc.product.LCSProduct|com.ptcmscloud.scApparel$com_lcs_wc_product_LCSProduct|com.ptcmscloud.scAeropostale$com_lcs_wc_product_LCSProduct~MBA|typeInfoLCSProduct.ptc_lng_1</column>
      </reportAttribute>
      <reportAttribute heading="Brand" reportAttributeId="Brand_1" userCanSelect="true" userCanConstrain="true" alwaysSelect="false" defaultValue="" constantValue="" isMacro="false">
        <column alias="Aeropostale (com.ptcmscloud.scAeropostale_com_lcs_wc_product_LCSProduct)" isExternal="false" type="java.lang.String" propertyName="WCTYPE|com.lcs.wc.product.LCSProduct|com.ptcmscloud.scApparel$com_lcs_wc_product_LCSProduct|com.ptcmscloud.scAeropostale$com_lcs_wc_product_LCSProduct~MBA|typeInfoLCSProduct.ptc_str_13">WCTYPE|com.lcs.wc.product.LCSProduct|com.ptcmscloud.scApparel$com_lcs_wc_product_LCSProduct|com.ptcmscloud.scAeropostale$com_lcs_wc_product_LCSProduct~MBA|typeInfoLCSProduct.ptc_str_13</column>
      </reportAttribute>
      <reportAttribute heading="Gender" reportAttributeId="Gender_1" userCanSelect="true" userCanConstrain="true" alwaysSelect="false" defaultValue="" constantValue="" isMacro="false">
        <column alias="Aeropostale (com.ptcmscloud.scAeropostale_com_lcs_wc_product_LCSProduct)" isExternal="false" type="java.lang.String" propertyName="WCTYPE|com.lcs.wc.product.LCSProduct|com.ptcmscloud.scApparel$com_lcs_wc_product_LCSProduct|com.ptcmscloud.scAeropostale$com_lcs_wc_product_LCSProduct~MBA|typeInfoLCSProduct.ptc_str_14">WCTYPE|com.lcs.wc.product.LCSProduct|com.ptcmscloud.scApparel$com_lcs_wc_product_LCSProduct|com.ptcmscloud.scAeropostale$com_lcs_wc_product_LCSProduct~MBA|typeInfoLCSProduct.ptc_str_14</column>
      </reportAttribute>
      <reportAttribute heading="Category" reportAttributeId="Department_1" userCanSelect="true" userCanConstrain="true" alwaysSelect="false" defaultValue="" constantValue="" isMacro="false">
        <column alias="Aeropostale (com.ptcmscloud.scAeropostale_com_lcs_wc_product_LCSProduct)" isExternal="false" type="java.lang.String" propertyName="WCTYPE|com.lcs.wc.product.LCSProduct|com.ptcmscloud.scApparel$com_lcs_wc_product_LCSProduct|com.ptcmscloud.scAeropostale$com_lcs_wc_product_LCSProduct~MBA|typeInfoLCSProduct.ptc_str_60">WCTYPE|com.lcs.wc.product.LCSProduct|com.ptcmscloud.scApparel$com_lcs_wc_product_LCSProduct|com.ptcmscloud.scAeropostale$com_lcs_wc_product_LCSProduct~MBA|typeInfoLCSProduct.ptc_str_60</column>
      </reportAttribute>
      <reportAttribute heading="Sourcing Name" reportAttributeId="Name_2" userCanSelect="true" userCanConstrain="true" alwaysSelect="false" defaultValue="" constantValue="" isMacro="false">
      ...
      <reportAttribute heading="Spec Name" reportAttributeId="Name_3" userCanSelect="true" userCanConstrain="true" alwaysSelect="false" defaultValue="" constantValue="" isMacro="false">
      ...
      <reportAttribute heading="BOM Name" reportAttributeId="Name_4" userCanSelect="true" userCanConstrain="true" alwaysSelect="false" defaultValue="" constantValue="" isMacro="false">
      ...
      <reportAttribute heading="Name" reportAttributeId="Supplier_Name" userCanSelect="true" userCanConstrain="true" alwaysSelect="false" defaultValue="" constantValue="" isMacro="false">
        <column alias="Vendor (Supplier)" isExternal="false" type="java.lang.String" propertyName="supplierName">master&gt;supplierName</column>
      </reportAttribute>
      <reportAttribute heading="Designer 1" reportAttributeId="DesignerName" userCanSelect="true" userCanConstrain="true" alwaysSelect="false" defaultValue="" constantValue="" isMacro="false">
        <script className="com.sparc.wc.report.SparcReportHelper" name="getDisplayValueForAtts" type="">
          <column alias="Aeropostale (com.ptcmscloud.scAeropostale_com_lcs_wc_season_LCSProductSeasonLink)" isExternal="false" type="long" propertyName="persistInfo.objectIdentifier.id">thePersistInfo.theObjectIdentifier.id</column>
          <constant type="java.lang.String" isMacro="false" xml:space="preserve">scDesigner</constant>
          <object alias="Aeropostale (com.ptcmscloud.scAeropostale_com_lcs_wc_season_LCSProductSeasonLink)" propertyName="conceptualClassname"/>
        </script>
      </reportAttribute>
    ...
    <from>
      <table alias="Aeropostale (com.ptcmscloud.scAeropostale_com_lcs_wc_product_LCSProduct)" isExternal="false" xposition="0px" yposition="40px">WCTYPE|com.lcs.wc.product.LCSProduct|com.ptcmscloud.scApparel$com_lcs_wc_product_LCSProduct|com.ptcmscloud.scAeropostale$com_lcs_wc_product_LCSProduct</table>
      <table alias="Aeropostale (com.ptcmscloud.scAeropostale_com_lcs_wc_season_LCSProductSeasonLink)" isExternal="false" xposition="0px" yposition="80px">WCTYPE|com.lcs.wc.season.LCSProductSeasonLink|com.ptcmscloud.scApparel$com_lcs_wc_season_LCSProductSeasonLink|com.ptcmscloud.scAeropostale$com_lcs_wc_season_LCSProductSeasonLink</table>
      <table alias="Aeropostale (com.ptcmscloud.scAeropostaleSeason)" isExternal="false" xposition="0px" yposition="120px">WCTYPE|com.lcs.wc.season.LCSSeason|com.ptcmscloud.scAeropostaleSeason</table>
      ...
      <table alias="General (com.ptcmscloud.general)" isExternal="false" xposition="0px" yposition="240px">WCTYPE|com.lcs.wc.specification.FlexSpecification|com.ptcmscloud.general</table>
      <table alias="Flex Specification To Season Link" isExternal="false" xposition="0px" yposition="280px">com.lcs.wc.specification.FlexSpecToSeasonLink</table>
      <table alias="Flex Specification To Component Link" isExternal="false" xposition="0px" yposition="320px">com.lcs.wc.specification.FlexSpecToComponentLink</table>
      <table alias="Apparel (com.ptcmscloud.scApparel_com_lcs_wc_flexbom_FlexBOMPart)" isExternal="false" xposition="0px" yposition="360px">WCTYPE|com.lcs.wc.flexbom.FlexBOMPart|com.ptcmscloud.Materials_BOM$com_lcs_wc_flexbom_FlexBOMPart|com.ptcmscloud.scApparel$com_lcs_wc_flexbom_FlexBOMPart</table>
      <table alias="Apparel (com.ptcmscloud.scApparel_com_lcs_wc_flexbom_FlexBOMLink)" isExternal="false" xposition="0px" yposition="400px">WCTYPE|com.lcs.wc.flexbom.FlexBOMLink|com.ptcmscloud.Materials_BOM$com_lcs_wc_flexbom_FlexBOMLink|com.ptcmscloud.scApparel$com_lcs_wc_flexbom_FlexBOMLink</table>
    ...
    <where>
      <compositeCondition type="and">
        <condition>
          <standardCondition>
            <operand>
              <column alias="Aeropostale (com.ptcmscloud.scAeropostale_com_lcs_wc_product_LCSProduct)" isExternal="false" type="boolean" propertyName="latestIteration">iterationInfo.latest</column>
            </operand>
            <operator type="equal"/>
            <operand>
        ...
        <condition>
          <standardCondition>
            <operand>
              <column alias="Aeropostale (com.ptcmscloud.scAeropostale_com_lcs_wc_season_LCSProductSeasonLink)" isExternal="false" type="boolean" propertyName="effectLatest">effectLatest</column>
            </operand>
            <operator type="equal"/>
            <operand>
              <constant type="boolean" isMacro="false" xml:space="preserve">1</constant>
        ...
        <condition>
          <nullCondition>
            <operand>
              <column alias="Aeropostale (com.ptcmscloud.scAeropostale_com_lcs_wc_season_LCSProductSeasonLink)" isExternal="false" type="java.sql.Timestamp" propertyName="effectOutDate">effectOutDate</column>
            </operand>
        ...
        <condition>
          <standardCondition>
            <operand>
              <column alias="Aeropostale (com.ptcmscloud.scAeropostale_com_lcs_wc_season_LCSProductSeasonLink)" isExternal="false" type="boolean" propertyName="seasonRemoved">seasonRemoved</column>
            </operand>
            <operator type="equal"/>
            <operand>
        ...
        <condition>
          <standardCondition>
            <operand>
              <column alias="Aeropostale (com.ptcmscloud.scAeropostaleSeason)" isExternal="false" type="boolean" propertyName="latestIteration">iterationInfo.latest</column>
            </operand>
            <operator type="equal"/>
            <operand>
              <constant type="boolean" isMacro="false" xml:space="preserve">1</constant>
        ...
        <condition>
          <standardCondition>
            <operand>
              <column alias="Aeropostale (com.ptcmscloud.scAeropostale_com_lcs_wc_product_LCSProduct)" isExternal="false" type="java.lang.String" propertyName="versionInfo.identifier.versionId">versionInfo.identifier.versionId</column>
            </operand>
            <operator type="equal"/>
            <operand>
        ...
        <condition>
          <standardCondition>
            <operand>
              <column alias="Aeropostale (com.ptcmscloud.scAeropostale_com_lcs_wc_season_LCSProductSeasonLink)" isExternal="false" type="double" propertyName="seasonRevId">seasonRevId</column>
            </operand>
            <operator type="equal"/>
            <operand>
              <column alias="Aeropostale (com.ptcmscloud.scAeropostaleSeason)" isExternal="false" type="long" propertyName="iterationInfo.branchId">iterationInfo.branchId</column>
            </operand>
          </standardCondition>
        </condition>
        <condition>
          <standardCondition>
            <operand>
              <column alias="Aeropostale (com.ptcmscloud.scAeropostale_com_lcs_wc_season_LCSProductSeasonLink)" isExternal="false" type="double" propertyName="productARevId">productARevId</column>
            </operand>
            <operator type="equal"/>
            <operand>
              <column alias="Aeropostale (com.ptcmscloud.scAeropostale_com_lcs_wc_product_LCSProduct)" isExternal="false" type="long" propertyName="iterationInfo.branchId">iterationInfo.branchId</column>
            </operand>
          </standardCondition>
        </condition>
        <condition>
          <standardCondition>
            <operand>
              <column alias="Aeropostale (com.ptcmscloud.scAeropostale_com_lcs_wc_product_LCSProduct)" isExternal="false" type="long" propertyName="masterReference.objectId.id">masterReference.key.id</column>
            </operand>
            <operator type="equal"/>
            <operand>
        ...
        <condition>
          <standardCondition>
            ...
            <operator type="equal"/>
            <operand>
              <column alias="Aeropostale (com.ptcmscloud.scAeropostaleSeason)" isExternal="false" type="long" propertyName="masterReference.objectId.id">masterReference.key.id</column>
            </operand>
          </standardCondition>
        </condition>
        <condition>
